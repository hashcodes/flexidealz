...
<div id="main">
  ...
  <form action="register.php" method="POST">
	...
	<input type="text" name="contactNo" id="contactNo" value="" class="form-control" required="required">
	<br clear="all">
	<br>
	<label for="replace">Ticket No :</label>
 	<input type="text" name="ticketNo" id="ticketNo" value="" class="form-control" required="required">
    <input type="hidden" name="imagePath" id="imagePath" value="<?php echo $my_upload->show_error_string(); ?>" class="form-control" required="required">	
