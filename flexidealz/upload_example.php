<?php
include($_SERVER['DOCUMENT_ROOT']."/upload/upload_class.php"); //classes is the map where the class file is stored (one above the root)
...
<body>
<div id="main">
  <h2 style="text-align:center;margin-top:10px;">Contenst</h2>
  ...
  <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data" name="form1" id="imgForm">
    <label for="replace">Name</label>
	<input type="text" name="replace" id="replace" value="y"><br clear="all">
	<label for="replace">Conatct No</label>
	<input type="text" name="replace" id="replace" value="y"><br clear="all">
	<input type="hidden" name="MAX_FILE_SIZE" value="<?php echo $max_size; ?>">
	<center><input type="file" name="upload" id="upload" size="25" onchange="$('#imgForm').submit();"></center>
	...
	<br clear="all">	
	<center><input type="button" name="Submit" id="Submit" value="Submit" onclick="saveDetails();"></center>
  </form>
