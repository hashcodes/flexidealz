...
<div id="main">
  ...
  <p><b> Note:</b> Upload image and click on submit button then save all the details.
  <br>
 <strong> Selfie name should be in format Yourname_Contact Number  </strong>
  e.g. AmitMistry_94123355245.jpg.  
  </p>
	...
	<br clear="all">	
	<center><input type="submit" name="Submit" id="Submit" value="Upload"></center>
  </form>
