  ...
  <div class="container">
	...
	<div class="about_content">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					...
					<br>
					<h2 class="bottom-border">Terms Of Use</h2>
					<h4>
						<strong>Welcome to Flexideals !!</strong>
					</h4>
					<p>Thanks for using our services.By using our Services, you are
						agreeing to these terms. Please read them carefully. Our Services
						are very diverse, so sometimes additional terms or product
						requirements (including age requirements) may apply. Additional
					...
					<p>You must follow any policies made available to you within
						the Services. Don’t misuse our Services. For example, don’t
						...
						the content you access. You may not use content from our Services
						unless you obtain permission from its owner or are otherwise
						permitted by law.</p>
					<p>These terms do not grant you the right to use any branding
						or logos used in our Services. Don’t remove, obscure, or alter any
						legal notices displayed in or along with our Services. Our
						Services display some content that is not property of Flexideal.
						This content is the sole responsibility of the entity that makes
						...
						your use of the Services, we may send you service announcements,
						...
						mobile devices. Do not use such Services in a way that distracts
						you and prevents you from obeying traffic or safety laws.</p>
					<h4>
						<strong>About Flexideal Account</strong>
					</h4>
					<p>You may need a Flexideal Account in order to use some of our
						Services.In case of misuse our administrator may be able to access
						or disable your account. To protect your Account, keep your
						password confidential.</p>
					<br>
					<h2 class="bottom-border">Privacy Policies</h2>
					<h4>
						<strong>Privacy and Copyright Protection</strong>
					</h4>
					<p>Flexideal’s privacy policies explain how we treat your
						personal data and protect your privacy when you use our Services.
						By using our Services, you agree that Flexideal can use such data
						in accordance with our privacy policies.</p>
					<h4>
						<strong>Your Content in our Services</strong>
					</h4>
					<p>Some of our Services allow you to upload, submit, store,
						send or receive content. You retain ownership of any intellectual
						property rights that you hold in that content. In short, what
						belongs to you stays yours.When you upload, submit, store, send or
						receive content to or through our Services, you give Flexideal
						...
						to develop new ones. Some Services may offer you ways to access
						and remove content that has been provided to that Service. Also,
						in some of our Services, there are terms or settings that narrow
					...
					<p>Our automated systems analyze your content (including
						...
						received, and when it is stored. You can stop using our Services
						at any time, although we’ll be sorry to see you go. Flexideal may
						also stop providing Services to you, or add or create new limits
						to our Services at any time. We believe that you own your data and
						preserving your access to such data is important. If we
						discontinue a Service, where reasonably possible, we will give you
						reasonable advance notice and a chance to get information out of
						that Service.</p>
					<h4>
					...
					<p>We may modify these terms or any additional terms that apply
						...
						discontinue your use of that Service.If there is a conflict
						between these terms and the additional terms, the additional terms
						will control for that conflict. These terms control the
						relationship between Flexideal and you. They do not create any
						third party beneficiary rights.If you do not comply with these
						terms, and we don’t take action right away, this doesn’t mean that
						we are giving up any rights that we may have (such as taking
						action in the future).If it turns out that a particular term is
						not enforceable, this will not affect any other terms.</p>
					<h4>
						<strong>Flexideal Safety Recomendations</strong>
					</h4>
					<ul>
						<li>Keeping the web safe for everyone is a shared
							responsibility.</li>
						<li>Learn what you can do to protect yourself and your family
							online.</li>
					</ul>
					<h2 class="bottom-border"></h2>
				</div>
				<!-- <div class="col-md-4">
        ...
        <div class="panel-group" id="accordion-alt3">
           <img class="img-responsive" alt="Our Advantages" src="images/addvantages.png">
        </div>
      </div> -->
			</div>
		</div>
